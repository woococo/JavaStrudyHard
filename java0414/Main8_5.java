...
import java.text.SimpleDateFormat;	// SimpleDateFormat을 사용하기 위해 임포트한다.
import java.util.Calendar; // Calendar를 사용하기 위해 임포트한다.
...
public class Main8_5 {
	...
	public static void main(String[] args) {
		...
		SimpleDateFormat k33_sdt = new SimpleDateFormat ("YYYY/MM/dd HH:mm:ss"); 	// SimpleDateFormat클래스로 출력형식 YYYY/MM/dd HH:mm:ss로 지정한다.
		...
		System.out.printf("최종실행시간 : %s\n", k33_sdt.format(k33_calt.getTime()));
		System.out.printf("***********************************************************************************\n");
	}
}
