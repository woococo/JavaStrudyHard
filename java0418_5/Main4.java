...
public class Main4 {
	...
	public static void main(String[] args) {
		...
		SimpleDateFormat k33_sdtA = new SimpleDateFormat("YYYY/MM/dd HH:mm:ss");	// 현재 시간을 어떻게 출력할지 포맷을 k33_sdtA 이름으로 정해준다.
		...
		int k33_price = (int)(k33_totalPrice / k33_taxRate);	
		// 부가세를 제외한 상품가격을 알기 위해서 k33_totalPrice를 부가세(k33_taxRate)로 나눈 값을 정수형으로 변환해서 k33_price에 대입한다.
