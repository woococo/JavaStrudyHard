...
public class Main5 {
	...
	public static void main(String[] args) {
		...
		int k33_price = (int) (k33_totalPrice / (1 + k33_taxRate)); // 부가세를 제외한 가격을 알기 위해서 k33_totalPrice에 k33_taxRate에
																	// 1을 더한 값을 정수형으로 변환해준다.
		int k33_tax = k33_totalPrice - k33_price; // 부가세인 k33_tax는 k33_totalPrice에서 k33_price를 뺀 값이다. (부가세 포함가격 - 부가세
													// 제외한 가격)
		...
		System.out.printf("%7s %d %s \n[%s]\n", k33_df.format(k33_price1), k33_amount1, // 상품가격과 갯수, 상품가격과 갯수를 곱한 금액을
																						// 출력해준다.
		...
		System.out.printf("%7s %d %s \n[%s]\n", k33_df.format(k33_price2), k33_amount2, // 상품가격과 갯수, 상품가격과 갯수를 곱한 금액을
																						// 출력해준다.
		...
		System.out.printf("%7s %d %s \n[%s]\n", k33_df.format(k33_price3), k33_amount3, // 상품가격과 갯수, 상품가격과 갯수를 곱한 금액을
																						// 출력해준다.
		...
		System.out.printf("%s\n", "-----------------------------------------");
		System.out.printf("%s%33s\n", "우리카드", "538720**********");
		System.out.printf("%s%12s%s\n", "승인번호 77982843(0)", "승인금액 ", k33_df.format(k33_totalPrice)); // 승인금액을 숫자 포맷에 맞춰
																									// 출력한다.
		System.out.printf("%s\n", "=========================================");
	...
	public static void k33_printItemName(String k33_itemName) { // 상품명을 출력하기 위한 함수이다
		int k33_cutLength = 26; // 상품명을 짜르고 싶은 바이트로 설정한다.
		...
		System.out.printf("%S", k33_itemName);
	}
}
