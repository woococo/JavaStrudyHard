...
// 삼성전자(단축코드 : A005930)만 추출하여 A005930.csv 파일을 만드시오

public class p07_Main1 {
	...
	public static void main(String[] args) throws IOException {
		...
		while ((k33_readtxt = k33_br.readLine()) != null) {
			...
			if (k33_field[2].equals(k33_code)) {
