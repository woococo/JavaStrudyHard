...
public class p06_Main {
	...
	public static void main(String[] args) throws IOException {
		...
		// 버퍼로 StockDailyPrice.csv파일을 생성하고 내용을 입력하자
